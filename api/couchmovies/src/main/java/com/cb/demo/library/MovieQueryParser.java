...
import com.cb.demo.repositories.ActorNameRepository;
...
public class MovieQueryParser {
    ...
    private void extractEntities(EntityExtractor entityExtractor) {
        ...
        for(String shingle: shingles) {
            //actorNameRepository.findById( is apparently not implemented??
            Optional<ActorName> actorName = actorNameRepository.findById(getActorNameId(shingle));
            //changed to the following
            //Optional<ActorName> actorName = Optional.of(actorNameRepository.findOne(getActorNameId(shingle)));
